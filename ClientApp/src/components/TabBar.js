...
function TabBar({ activeTab }) {
    ...
    const getExplore = color => {
        return (
            <div style={tabIcon} onClick={() => { navigate('/explore') }} key="0">
                ...
                <p style={{ ...tabIconText, color: color }}>Explore</p>
            </div>
        )
    }
    ...
    const getSchedule = color => {
        return (
            <div style={tabIcon} onClick={() => { navigate('/schedule') }} key="1">
                <svg width="30" height="30" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <p style={{ ...tabIconText, color: color }}>Schedule</p>
            </div>
        )
    }
    ...
    const getProfile = color => {
        return (
            <div style={tabIcon} onClick={() => { navigate('/profile') }} key="3">
                ...
                <p style={{ ...tabIconText, color: color }}>Profile</p>
            </div>
        )
    }
    ...
    const getWall = color => {
        return (
            <div style={tabIcon} onClick={() => { navigate('/wall') }} key="2">
                ...
                <p style={{ ...tabIconText, color: color }}>Wall</p>
            </div>
        )
    }
