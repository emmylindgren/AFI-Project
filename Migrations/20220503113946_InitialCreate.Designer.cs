...
namespace AFI_Project.Migrations
{
    ...
    [Migration("20220503113946_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AFI_Project.Models.EventModel", b =>
                {
                    ...
                    b.Property<int?>("DisabilityModelDi_Id")
                        .HasColumnType("int");
                    ...
                    b.Property<int?>("EventCategoryModelCat_Id")
                        .HasColumnType("int");

                    b.HasKey("Ev_Id");

                    b.HasIndex("DisabilityModelDi_Id");

                    b.HasIndex("Ev_OwnerPr_Id");

                    b.HasIndex("EventCategoryModelCat_Id");
            ...
            modelBuilder.Entity("AFI_Project.Models.EventModel", b =>
                {
                    b.HasOne("AFI_Project.Models.DisabilityModel", null)
                        .WithMany("Di_Events")
                        .HasForeignKey("DisabilityModelDi_Id");
                    ...
                    b.HasOne("AFI_Project.Models.EventCategoryModel", null)
                        .WithMany("Cat_Events")
                        .HasForeignKey("EventCategoryModelCat_Id");
